...
namespace TranslatorUI {
    ...
    public partial class UpdateWindow : Window {
        ...
        private void disableEverything() {
            ...
            txtLocalVersion.Text = MainWindow.Version;
        }
        ...
        private static void asyncHasUpdateResp(MainWindow instance, bool hasUpdate) {
            if (hasUpdate) {
                instance.asyncFoundUpdate();
            }
        }

        public static void checkForAutoUpdatesOnBackground(MainWindow instance) {
            ...
            aw.addJob(asyncHasUpdate, MainWindow.Version, (object o) => { asyncHasUpdateResp(instance, (bool)o); });
        }
